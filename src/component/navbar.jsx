...
const Navbar = () => {
  ...
  <div className=" justify-end flex-none w-3/5 ">
    <ul className=" text-xl menu menu-horizontal px-10 bg-red-1 gap-16 text-black mr-24">
      <li><div className="dropdown">
            <div tabIndex={0} role="button" className="">Announce</div>
            <div tabIndex={0} className="dropdown-content z-[1] card card-compact w-64 p-2 shadow bg-primary text-primary-content">
              <div className="card-body">
                ...
                <p>ขออภัย ณ ปัจจุบันยังอยู่ในการพัฒนายังมีบางส่วนไม่สมบูรณ์</p>
              </div>
            </div>
          </div>
      </li>
